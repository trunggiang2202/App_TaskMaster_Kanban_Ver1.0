                                ...
                                >
                                    {WEEKDAY_INDICES.map((dayIndex, arrayIndex) => (
                                        <ToggleGroupItem 
                                          ...
                                          className="bg-primary/5 border-primary/20 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground data-[state=on]:border-primary hover:text-primary hover:scale-110 transform transition-transform hover:bg-primary/10"
                                        >
