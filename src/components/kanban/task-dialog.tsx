              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="ví dụ: Hoàn thành báo cáo dự án" {...field} className="bg-muted/40"/>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Thêm chi tiết về nhiệm vụ..." {...field} className="bg-muted/40"/>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="31-12-2024" {...field} className="bg-muted/40"/>
                              </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="09:00" {...field} className="w-24 bg-muted/40"/>
                              </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Giờ</FormLabel>
                            <FormControl>
                                <Input placeholder="05:00" {...field} className="w-24 bg-muted/40"/>
                              </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
